...
export const EMAIL_REGEX_ERROR_MESSAGE = 'Please provide correct email';
export const EMAIL_MISSING_ERROR_MESSAGE = 'Please input your email!';
export const BODY_MISSING_ERROR_MESSAGE = 'Please input body!';
